export default {
  intro: [
    // {
    //   speaker: null,
    //   sentence: '< 简单的Introduction >'
    // },
    // {
    //   speaker: null,
    //   sentence: '你有没有因为“意志力”不够强大没有实现的愿望？'
    // },
    {
      speaker: null,
      sentence:
        '不妙！坏习惯的怪物想要掌控你的生活。打败那些坏蛋的唯一办法是用 WILL-POWER！'
    },
    {
      speaker: null,
      sentence: '< 规则解说 >'
    ...
    },
    {
      speaker: null,
      sentence:
        '**提示1** 服务器会在每晚11点检查当天WILL的完成情况。请不要拖延到最后一刻再完成will喔。'
    },
    {
      speaker: null,
      sentence:
        '**提示2** 目前还是早期的DEMO，数据可能删除，并且有各种bug。但我有长期维护这个APP的计划（因为自己也想用），如果有兴趣的话请期待'
    }
  ]
};
